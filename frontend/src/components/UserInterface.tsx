...
interface UserInterfaceProps {
  ...
  const buttonColors: { [key: string]: string } = {
    go: 'bg-gray-500 hover:bg-gray-200',
  };
...
{/* Create user */}
        <form onSubmit={createUser} className="mb-6 p-4 bg-gray-700 rounded shadow">
            <input
            placeholder="Name"
            value={newUser.name}
            ...
            className="mb-2 w-full p-2 border border-gray-300 rounded"
            />
                <button type="submit" className="w-full p-2 text-white bg-red-700 rounded hover:bg-blue-600">
                Add User
                </button>
        </form>
...
<form onSubmit={handleUpdateUser} className="mb-6 p-4 bg-blue-100 rounded shadow">
      <input
        ...
        <input
          ...
          className="mb-2 w-full p-2 border border-gray-300 rounded"
        />
        <button type="submit" className="w-full p-2 text-white bg-amber-500 rounded hover:bg-green-600">
          Update User
        </button>
      </form>
